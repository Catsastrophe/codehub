...
db = TinyDB('db.json')  # TinyDB will create a file named db.json to store the data
...
# Example route in your Flask app
...
def register():
    if request.method == 'POST':
        ...
        # Check if the username is already taken (you may want to check the database)
        UserTable = Query()
